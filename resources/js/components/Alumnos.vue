    ...
    <div class="container-fluid">
                     ...
                     <tr v-for="user in users" :key="user.id">
                      ...
                      <td> 
                        <center> 
                          ...
                          <a href="#" @click="obtenerDatosEscolares(user)"> <i class="fas fa-graduation-cap"></i> </a>
        ...
        <div class="modal fade" id="addNew" tabindex="-1" role="dialog" aria-labelledby="addNew" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" v-show="!editmode">Agregar nuevo alumno</h5>
                    <h5 class="modal-title" v-show="editmode">Actualizar información del alumno</h5>
        ...
        <div class="modal fade" id="addData" tabindex="-1" role="dialog" aria-labelledby="addData" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" > Datos personales del alumno </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
        ...
        <!-- Modal de datos escolares-->
        <div class="modal fade" id="addEscolar" tabindex="-1" role="dialog" aria-labelledby="addEscolar" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" > Datos escolares del alumno </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form @submit.prevent="guardarDatosEscolares()">
                    <div class="modal-body">

                        <div class="form-group">
                            <label>Fecha ingreso</label>
                            <input v-model="infoEscolar.ingreso" type="date" name="fecha_ingreso"
                                class="form-control" >
                        </div>

                        <div class="form-group">
                            <label>Fecha Finalización</label>
                            <input v-model="infoEscolar.finalizacion" type="date" name="finalizacion"
                                class="form-control">
                        </div>
                        
                        <div class="form-group">
                            <label>Semestre</label>
                            <input v-model="infoEscolar.semestre" type="number" name="semestre"
                                class="form-control" >
                        </div>
                    
                        <div class="form-group">
                            <label>Carrera</label>
                            <input v-model="infoEscolar.carrera" type="text" name="carrera"
                                class="form-control" >
                        </div>
                        
                        <div class="form-group">
                            <label>Facultad</label>
                            <input v-model="infoEscolar.facultad" type="text" name="facultad"
                                class="form-control" >
                        </div>

                        <div class="form-group">
                            <label>Código</label>
                            <input v-model="infoEscolar.codigo" type="text" name="codigo"
                                class="form-control" >
                        </div>

                        <div class="form-group">
                            <label>Creditos</label>
                            <input v-model="infoEscolar.creditos" type="number" name="creditos"
                                class="form-control" >
                        </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            updateUser(){
                this.$Progress.start();
                this.form.put('api/actualizar/alumno/'+this.form.id)
                .then((response) => {
                    $('#addNew').modal('hide');
                    Toast.fire({
                      icon: 'success',
          ...
          loadUsers(){
            ...
            if(this.$gate.isAdmin()){
              axios.get("api/user/alumnos").then(({ data }) => (this.users = data.data));
            }

            this.$Progress.finish();
          },
          createUser(){
              this.form.post('api/alumno/crear')
              .then((response)=>{
                  $('#addNew').modal('hide');
                  Toast.fire({
                        icon: 'success',
