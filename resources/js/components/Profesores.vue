    ...
    <div class="container-fluid">
        ...
        <div class="modal fade" id="addData" tabindex="-1" role="dialog" aria-labelledby="addData" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" > Datos personales del profesor </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
        ...
        <div class="modal fade" id="addEscolar" tabindex="-1" role="dialog" aria-labelledby="addEscolar" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" > Datos escolares del profesor </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
        ...
        methods: {
          ...
          guardarDatos(){
            ...
            updateUser(){
                ...
                this.form.put('api/actualizar/profesor/'+this.form.id)
                .then((response) => {
                    // success
                    $('#addNew').modal('hide');
                    Toast.fire({
          ...
          loadUsers(){
            ...
            if(this.$gate.isAdmin()){
              axios.get("api/user/profesores").then(({ data }) => (this.users = data.data));
            }
          ...
          createUser(){
              ...
              this.form.post('api/profesor/crear')
              .then((response)=>{
                  $('#addNew').modal('hide');
